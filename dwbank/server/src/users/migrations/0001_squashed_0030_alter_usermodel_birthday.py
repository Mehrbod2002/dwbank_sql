...
class Migration(migrations.Migration):
    ...
    replaces = [('users', '0001_initial'), ('users', '0002_alter_usermodel_birthday'), ('users', '0003_alter_usermodel_birthday'), ('users', '0004_alter_usermodel_birthday'), ('users', '0005_alter_usermodel_birthday'), ('users', '0006_alter_usermodel_birthday'), ('users', '0007_alter_usermodel_birthday'), ('users', '0008_alter_usermodel_birthday'), ('users', '0009_alter_usermodel_birthday'), ('users', '0010_alter_usermodel_birthday'), ('users', '0011_alter_usermodel_birthday'), ('users', '0012_alter_usermodel_birthday'), ('users', '0013_alter_usermodel_birthday'), ('users', '0014_alter_usermodel_birthday'), ('users', '0015_alter_usermodel_birthday'), ('users', '0016_alter_usermodel_birthday'), ('users', '0017_alter_usermodel_birthday'), ('users', '0018_alter_usermodel_birthday'), ('users', '0019_alter_usermodel_birthday'), ('users', '0020_alter_usermodel_birthday'), ('users', '0021_alter_usermodel_birthday'), ('users', '0022_alter_usermodel_birthday'), ('users', '0023_alter_usermodel_birthday'), ('users', '0024_alter_usermodel_birthday'), ('users', '0025_alter_usermodel_birthday'), ('users', '0026_alter_usermodel_birthday'), ('users', '0027_alter_usermodel_birthday'), ('users', '0028_alter_usermodel_birthday'), ('users', '0029_alter_usermodel_birthday'), ('users', '0030_alter_usermodel_birthday')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(default=datetime.datetime(2023, 9, 26, 6, 55, 55, 258574, tzinfo=datetime.timezone.utc), verbose_name='Birthday')),
